...
export class InitialSchema1769927459045 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "categories" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "icon" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_24dbc6126a28ff948da33e97d3b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "game_categories" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "gameId" uuid NOT NULL, "categoryId" uuid NOT NULL, CONSTRAINT "PK_2f45558e74df1f63fb26d8eaf57" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "game_categories" ADD CONSTRAINT "FK_7f79df7fcb94cbb3415e0cb6750" FOREIGN KEY ("gameId") REFERENCES "games"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "game_categories" ADD CONSTRAINT "FK_ebfae34b5512ef555dbe78bf6df" FOREIGN KEY ("categoryId") REFERENCES "categories"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "game_categories" DROP CONSTRAINT "FK_ebfae34b5512ef555dbe78bf6df"`,
    );
    await queryRunner.query(
      `ALTER TABLE "game_categories" DROP CONSTRAINT "FK_7f79df7fcb94cbb3415e0cb6750"`,
    );
